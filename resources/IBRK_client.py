...
class IBClient():
    ...
    def __init__(self, username: str, account: str, client_gateway_path: str = None,
        ...
        if client_gateway_path is None:
            ...
            if not self.client_portal_folder.exists():
                st.markdown("The Client Portal Gateway doesn't exist. You need to download it before using the Library.")
                st.markdown("Downloading the Client Portal file...")
    ...
    def create_session(self, set_server=True) -> bool:
        ...
        if self.server_process is None and not self._is_server_running:
            ...
            if set_server:
                self.connect(start_server=False, check_user_input=True)
            else:
                self.connect(start_server=False, check_user_input=False)
                return True
    ...
    def _check_authentication_user_input(self) -> bool:
        ...
        # If no, close the session.
            ...
            if 'statusCode' in auth_response.keys() and auth_response['statusCode'] == 401:
                st.markdown("Session isn't connected, closing script.")
                self.close_session()
    ...
    def connect(self, start_server: bool = True, check_user_input: bool = True) -> bool:
        ...
        if check_user_input:
            ...
            # st.markdown(textwrap.dedent("""{lin_brk}
    ...
    # DEPRECATED BY IBRK (30/11/2021) https://interactivebrokers.github.io/cpwebapi/swagger-ui.html
